...
uniform float arcAlpha;
uniform float innerSpeed;
uniform float outerSpeed;
...
{
l9_5=atan(l9_4,l9_3.x);
}
float l9_6=length(l9_3);
float l9_7=l9_5+6.283185;
float l9_8=mod(l9_7,6.283185);
float l9_9=mod((l9_8-mod((-sc_Time.x)*outerSpeed,6.283185))+6.283185,6.283185);
float l9_10;
if (((l9_9<=4.7123885)&&(l9_6>=0.34999999))&&(l9_6<=0.40000001))
{
l9_10=smoothstep(0.0,softness,l9_9)*smoothstep(0.0,softness,4.7123885-l9_9);
}
else
{
l9_10=0.0;
}
float l9_11=mod((l9_8-mod(sc_Time.x*innerSpeed,6.283185))+6.283185,6.283185);
float l9_12;
if (((l9_11<=4.7123885)&&(l9_6>=0.22))&&(l9_6<=0.25999999))
{
l9_12=smoothstep(0.0,softness,l9_11)*smoothstep(0.0,softness,4.7123885-l9_11);
}
else
{
l9_12=0.0;
}
float l9_13=max(l9_10,l9_12);
float l9_14=l9_13*arcAlpha;
vec4 l9_15=vec4(arcColor.xyz,l9_14);
...
{
l9_35=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_34,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_35=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_34,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_33=l9_35;
}
#endif
vec3 l9_36=mix(l9_33.xyz,definedBlend(l9_33.xyz,l9_15.xyz).xyz,vec3(l9_14));
...
#if (sc_Voxelization)
{
l9_38=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_39;
#if (sc_OutputBounds)
{
float l9_40=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_39=vec4(l9_40,1.0-l9_40,1.0,1.0);
}
#else
{
vec4 l9_41;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_41=vec4(mix(vec3(1.0),l9_15.xyz,vec3(l9_14)),l9_14);
}
#else
{
vec4 l9_42;
...
#endif
l9_42=vec4(l9_15.xyz*l9_43,l9_43);
}
#else
{
l9_42=l9_15;
...
vec4 l9_46=sc_OutputMotionVectorIfNeeded(max(l9_44,vec4(0.0)));
...
#endif
int l9_50=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_49).xy);
...
if (l9_67==0)
{
l9_70=texture(sc_OITAlpha0,l9_62);
l9_69=texture(sc_OITDepthLow0,l9_62);
l9_68=texture(sc_OITDepthHigh0,l9_62);
}
else
{
l9_70=vec4(0.0);
...
if (l9_67==1)
{
l9_73=texture(sc_OITAlpha1,l9_62);
l9_72=texture(sc_OITDepthLow1,l9_62);
l9_71=texture(sc_OITDepthHigh1,l9_62);
}
else
{
l9_73=l9_70;
...
vec4 l9_88=texture(sc_OITFilteredDepthBoundsTexture,l9_62);
vec2 l9_89=l9_88.xy;
int l9_90;
#if (sc_SkinBonesCount>0)
{
